 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_module']['marquee_legend']      = 'Laufschrift';

/**
 * Misc
 */
$GLOBALS['TL_LANG']['tl_module']['right'] = 'Von Links nach Rechts';
$GLOBALS['TL_LANG']['tl_module']['left']  = 'Von Rechts nach Links';
$GLOBALS['TL_LANG']['tl_module']['up']    = 'Von Oben nach Unten';
$GLOBALS['TL_LANG']['tl_module']['down']  = 'Von Unten nach Oben';
